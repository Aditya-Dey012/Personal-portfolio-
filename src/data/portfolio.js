...
export const projects = [
  {
    ...
    slug: 'llm-benchmark-dashboard',
    stack: ['FastAPI', 'React', 'TypeScript', 'Ollama', 'LangSmith', 'SQLite', 'sentence-transformers', 'Recharts'],
    description: 'Side-by-side evaluation platform for 5 local LLMs — Gemma 2B, Phi-3 Mini, DeepSeek Coder 6.7B, Mistral 7B, Llama 3.1 8B — all running via Ollama. Auto-scores each response on relevancy, faithfulness, and hallucination rate using MiniLM embeddings, with full LangSmith tracing, real-time progress in a React + TypeScript dashboard, and SQLite persistence. Zero API cost.',
